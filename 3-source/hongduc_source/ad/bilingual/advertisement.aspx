        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Banner name" DataField="CompanyName" SortExpression="CompanyName">
                        <ItemTemplate>
                            <%# Eval("CompanyName")%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                        ...
                        <ItemTemplate>
                            <div style="position: relative">
                                ...
                                <div runat="server" visible='<%# string.IsNullOrEmpty(Eval("FileName").ToString()) ? false : (!Eval("FileName").ToString().ToLower().EndsWith(".swf") ? true : false) %>'>
                                    <img id="Img2" alt="" height="100" width='300'
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1260px x 446px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
