<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="danhmuc.aspx.cs" Inherits="ad_single_articlecategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtLink" runat="server" Text='<%# Bind("ArticleCategoryLink") %>'
                                            Width="500px" EmptyMessage="Link...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtLinkEn" runat="server" Text='<%# Bind("ArticleCategoryLinkEn") %>'
                                            Width="500px" EmptyMessage="Link...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ArticleCategoryDelete"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="ArticleCategoryLink" Type="String" />
            <asp:Parameter Name="ArticleCategoryLinkEn" Type="String" />
