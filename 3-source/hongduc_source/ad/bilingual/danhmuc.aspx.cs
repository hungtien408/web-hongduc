...
public partial class ad_single_articlecategory : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string strLink = ((RadTextBox)row.FindControl("txtLink")).Text.Trim();
            string strLinkEn = ((RadTextBox)row.FindControl("txtLinkEn")).Text.Trim();
            ...
            {
                strImageName = oArticleCategory.ArticleCategoryInsert2(
            ...
            else
            {
                ...
                dsUpdateParam["ArticleCategoryLink"].DefaultValue = strLink;
                dsUpdateParam["ArticleCategoryLinkEn"].DefaultValue = strLinkEn;
